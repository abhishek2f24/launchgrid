...
const sql = fs.readFileSync(path.resolve(process.cwd(), 'supabase/migrations/0036_account_level_research_credits.sql'), 'utf8');

async function runMigration() {
  console.log('Connecting to database for Migration 0036...');
