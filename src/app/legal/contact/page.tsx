...
export default function ContactPage() {
  return (
    <>
      ...
      <h3>Registered Business Details</h3>
      <p><strong>Entity Name:</strong> LaunchGrid Software Pvt. Ltd.</p>
      <p><strong>Address:</strong><br />
      Level 4, LaunchGrid Tower,<br />
      ...
      <ul>
        ...
        <li><strong>Phone:</strong> +91 98765 43210 (Mon-Fri, 10 AM - 6 PM IST)</li>
      </ul>
