...
const sql = fs.readFileSync(path.resolve(process.cwd(), 'supabase/migrations/0041_evidence_store.sql'), 'utf8');

async function runMigration() {
  console.log('Connecting to database for Migration 0041...');
