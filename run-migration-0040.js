...
const sql = fs.readFileSync(path.resolve(process.cwd(), 'supabase/migrations/0040_research_fair_use_cap.sql'), 'utf8');

async function runMigration() {
  console.log('Connecting to database for Migration 0040...');
