...
const sql = fs.readFileSync(path.resolve(process.cwd(), 'supabase/migrations/0039_supplier_contact_details.sql'), 'utf8');

async function runMigration() {
  console.log('Connecting to database for Migration 0039...');
