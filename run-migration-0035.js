...
const sql = fs.readFileSync(path.resolve(process.cwd(), 'supabase/migrations/0035_on_demand_research_requests.sql'), 'utf8');

async function runMigration() {
  console.log('Connecting to database for Migration 0035...');
