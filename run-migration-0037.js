...
const sql = fs.readFileSync(path.resolve(process.cwd(), 'supabase/migrations/0037_free_tier_single_research.sql'), 'utf8');

async function runMigration() {
  console.log('Connecting to database for Migration 0037...');
