...
const sql = fs.readFileSync(path.resolve(process.cwd(), 'supabase/migrations/0042_investigations.sql'), 'utf8');

async function runMigration() {
  console.log('Connecting to database for Migration 0042...');
