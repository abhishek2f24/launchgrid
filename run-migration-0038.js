...
const sql = fs.readFileSync(path.resolve(process.cwd(), 'supabase/migrations/0038_credit_pack_purchases.sql'), 'utf8');

async function runMigration() {
  console.log('Connecting to database for Migration 0038...');
